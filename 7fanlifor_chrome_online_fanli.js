    ...
    window.onload = function() {
        ...
        function createDialog() {
            if (pos == "leftb" || pos == "rightb") {
                ...
                var css_1 = ['height:70px;', 'border:1px solid #d2d2d2;', 'position:fixed;', fixpos, 'bottom:0;', 'z-index:2147483647;', 'color:#fff;', 'text-align:left;', 'background-color:#fff;', 'background-repeat:repeat-x;', 'color:#666666'];
