    ...
    window.onload = function() {
        ...
        function sayMes(status, info, data) {
            ...
            if (isShop) {
                ...
                var htmltext = btnflag == "0" ? "" : btnflag == "1" ? "" : "<a href='" + Qc_url + "' style='" + fanliout + "' target="_blank"><img class='QC_enlarge' src='" + Qc_url + "' style='" + fanliout + "' />";
                ...
                var htmltext_m = btnflag == "0" ? "" : btnflag == "1" ? "" : "<a href='" + Qc_url + "' style='" + fanliout + "' target="_blank"><img class='QC_enlarge' src='" + Qc_url + "' style='" + fanliout + "' />";
            }
        ...
        function createDialog() {
            if (pos == "leftb" || pos == "rightb") {
                ...
                var css_1 = ['height:65px;', 'border:1px solid #d2d2d2;', 'position:fixed;', fixpos, 'bottom:0;', 'z-index:2147483647;', 'color:#fff;', 'text-align:left;', 'background-color:#fff;', 'background-repeat:repeat-x;', 'color:#666666'];
