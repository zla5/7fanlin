    ...
    window.onload = function() {
        ...
        function createDialog() {
            if (pos == "leftb" || pos == "rightb") {
                ...
                // taoke_content.innerHTML = '<ul id="ul_off" style="background:url(https://img.alicdn.com/imgextra/i4/380087440/TB2nsaThXXXXXcxXXXXXXXXXXXX-380087440.png) 20px 10px no-repeat;height:100px;position:relative;"><div id="div_off" style="position:absolute;"></div>' + '<li style="margin-top:20px;"><a id="qifanli_logo" href="https://7fanli.com" target="_blank"></a></li>' + '<li style="float:left;height:40px;width:1px;background-color:#e9e9e9;margin-top:17px;margin-left:80px;"></li>' + '<li id="tc_left" style="float:left;height:70px;display:flex;align-items:center;"><img src="https://img.alicdn.com/imgextra/i2/201544069/TB2eZ47XPS_LeJjSZFxXXaP8XXa-201544069.gif" height="70" width="70" style="margin-top:-20px"/></li>' + '<li id="tc_gf_cont" style="float:left"></li>' + '<li id="tc_jfb_cont" style="float:left;margin-top:23px;"></li>' + '<li style="float:left;height:48px;width:1px;margin-top:10px;"></li>' + '<li id="tc_btn" style="float:left"><a href="' + loginLocUrl + '?v=' + v + '" style="' + setout + '" onmouseout="this.style.cssText=\'' + setout + '\'" onmouseover="this.style.cssText=\'' + setout + '\'" target="_blank"></a></li><li style="float:left;width:100px;position:relative;top:-16px;margin-right:10px;"><a href="#" target="_blank"><img class="AD" style="width:90px;height:90px;" src="http://www.7fanli.com/guanggao.jpg" /></a></li>' + '</ul>' + '<div style="clear:both;"></div>'; //<li style="float:left;width:100px;position:relative;top:-16px;margin-right:10px;"><a href="https://tbvr.ews.m.jaeapp.com/vr/11-11/#/selected"><img class="AD" style="width:100px;height:83px;" src="http://www.7fanli.com/guanggao.jpg" /></a></li>
                taoke_content.innerHTML = '<ul id="ul_off" style="background:url(https://img.alicdn.com/imgextra/i4/380087440/TB2nsaThXXXXXcxXXXXXXXXXXXX-380087440.png) 20px 10px no-repeat;height:100px;position:relative;"><div id="div_off" style="position:absolute;"></div>' + '<li style="margin-top:20px;"><a id="qifanli_logo" href="https://7fanli.com" target="_blank"></a></li>' + '<li style="float:left;height:40px;width:1px;background-color:#e9e9e9;margin-top:17px;margin-left:80px;"></li>' + '<li id="tc_left" style="float:left;height:70px;display:flex;align-items:center;"><img src="https://img.alicdn.com/imgextra/i2/201544069/TB2eZ47XPS_LeJjSZFxXXaP8XXa-201544069.gif" height="70" width="70" style="margin-top:-20px"/></li>' + '<li id="tc_gf_cont" style="float:left"></li>' + '<li id="tc_jfb_cont" style="float:left;margin-top:23px;"></li>' + '<li style="float:left;height:48px;width:1px;margin-top:10px;"></li>' + '<li id="tc_btn" style="float:left"><a href="' + fanlisetting + '?v=' + v + '" style="' + setout + '" onmouseout="this.style.cssText=\'' + setout + '\'" onmouseover="this.style.cssText=\'' + setout + '\'" target="_blank"></a></li><li style="float:left;width:100px;position:relative;top:-16px;margin-right:10px;"><a href="#" target="_blank"><img class="AD" style="width:90px;height:90px;" src="http://www.7fanli.com/guanggao.jpg" /></a></li>' + '</ul>' + '<div style="clear:both;"></div>'; //<a href="https://tbvr.ews.m.jaeapp.com/vr/11-11/#/selected"><img class="AD" style="width:100px;height:83px;" src="http://www.7fanli.com/guanggao.jpg" /></a></li>
