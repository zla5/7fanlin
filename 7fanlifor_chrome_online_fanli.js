    ...
    window.onload = function() {
        ...
        function sayMes(status, info, data) {
            ...
            if (isShop) {
                ...
                var htmltext = btnflag == "0" ? "" : btnflag == "1" ? "" : "<a href='" + Qc_url + "'target="_blank"><img class='QC_enlarge' src='" + Qc_url + "' style='" + fanliout + "' />";
                ...
                var htmltext_m = btnflag == "0" ? "" : btnflag == "1" ? "" : "<a href='" + Qc_url + "'target="_blank"><img class='QC_enlarge' src='" + Qc_url + "' style='" + fanliout + "' />";
            }
